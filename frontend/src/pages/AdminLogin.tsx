...
const AdminLogin = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#F8FAFC] px-4 py-8">
            ...
            <Card className="w-full max-w-[440px] bg-white border-[#E5E7EB] shadow-[0_8px_30px_rgba(0,0,0,0.06)] rounded-[2.5rem] relative z-10 overflow-hidden">
            ...
            <div className="absolute bottom-6 text-[#94A3B8] text-[9px] font-black tracking-[0.3em] uppercase select-none">
