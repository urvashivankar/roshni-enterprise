...
import { LogOut, Activity, ArrowLeft, Sparkles } from 'lucide-react';
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-5 md:p-8 rounded-[2rem] shadow-sm border border-slate-100 gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-400 font-bold uppercase tracking-widest text-[9px] md:text-[10px]">Demand Forecasting & Insights</p>
                        </div>
                    </div>
